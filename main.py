...
def Spinner():
	l = ['|', '/', '-', '\\']
	for i in l+l+l:
		sys.stdout.write('\r' + Fore.GREEN +'Cation Token Gen is Starting...'+i)
		sys.stdout.flush()
		time.sleep(0.2)
...
print(Fore.WHITE +Fore.RED +"-\Welcome to "+Fore.BLUE+" Cation TokenGen -\-\-")
...
if opcion=='1':
	...
	while int(count)<int(cantidad):
		...
		if int(count)==int(cantidad):
			...
			os.system("cls")
			print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
			print(Fore.RED +Fore.RED +"                                                   Closing Cation TokenGen..")
			print(Fore.GREEN +Fore.RED +"                                               Subscribe ArcadeCodeZ On YouTube!")
			print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
			time.sleep(2)
			sys.exit()
			pass
	...
	with open('Generated.txt', 'r') as f:
	    for line in f:
	        ...
	        try:
	            ...
	            print(f"{Fore.CYAN}Error, please contact with ArcadeCodeZ#1197. via Discord! https://dsc.gg/ctnop {Fore.RESET}")
pass
if opcion=='3':
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	print(Fore.WHITE +Fore.RED +"                                         Cation TokenGen"+Fore.YELLOW+" Made by "+Fore.RED+"ArcadeCodeZ")
	print(Fore.WHITE +Fore.RED +"                                         [Discord] "+Fore.GREEN+"ArcadeCodeZ")
	print(Fore.BLUE +Fore.RED +"                                         [Server] "+Fore.RED+"https://dsc.gg/ctnops")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	input(Fore.RED +Fore.RED +"\nEnter to exit")
	os.system("cls")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	print(Fore.RED +Fore.RED +"                                                   Closing..")
	print(Fore.GREEN +Fore.RED +"                                               Subscribe To ArcadeCodeZ on YouTube!")
	print(Fore.WHITE +Fore.RED +"                         ["+Fore.WHITE +Fore.RED +"+"+Fore.WHITE +Fore.RED +"]"+ Fore.WHITE +Fore.RED +"-------------------------------------------------------"+ Fore.WHITE +Fore.RED +"["+ Fore.WHITE +Fore.RED +"+"+ Fore.WHITE +Fore.RED +"]")
	time.sleep(2)
	sys.exit()
	pass
...
#Cation TokenGen made by ArcadeCodeZ, Join discord server for help https://discord.gg/ctnop